            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <label for="EmployeeInputEmail">Votre email</label>
                  <input id="EmployeeInputEmail" type="email" data-testid="employee-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="EmployeeInputPassword">Mot de passe</label>
                  <input id="EmployeeInputPassword" type="password" data-testid="employee-password-input" class="form-control" placeholder="******" required>
